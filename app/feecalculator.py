...
class FeeCalculator:
    ...
    def calculate_delivery_fee(self) -> None:
    ...
    def calculate_extra_item_fee(self) -> None:
    ...
    def check_if_over_max_delivery_fee(self) -> None:
        if self.delivery_fee > Constants.MAX_DELIVERY_FEE:
            self.delivery_fee = Constants.MAX_DELIVERY_FEE

    def check_if_eligible_for_free_delivery(self) -> None:
